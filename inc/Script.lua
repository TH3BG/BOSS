...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "TH3BG"))
end
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3BG/th3bs.github.io/master/plugins/"..FileName)
if res == 200 then
